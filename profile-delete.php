...
<body>
	...
	<?php if(!empty($row)):?>
		...
		<div class="row col-lg-8 border rounded mx-auto mt-5 p-2 shadow-lg">
			...
			<br>
			<?php
				$imagePath = get_image($row['image']);

				if (file_exists($imagePath)) {
					echo '<img src="' . $imagePath . '" class="js-image img-fluid rounded" style="width: 180px; height: 180px; object-fit: cover;">';
				} else {
					echo '<img src="./images/no-image.jpg" class="js-image img-fluid rounded" style="width: 180px; height: 180px; object-fit: cover;">';
				}
			?>
