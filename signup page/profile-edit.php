	...
	<?php if(!empty($row)):?>
		...
		<div class="row col-lg-8 border rounded mx-auto mt-5 p-2 shadow-lg">
			...
			<div class="col-md-8">
				...
				<form method="post" onsubmit="myaction.collect_data(event, 'profile-edit')" id="edit">
					<table class="table table-striped">
						...
						<tr><th><i class="bi bi-person-circle"></i> Name</th>
							<td>
								<input value="<?=$row['firstname']?>" type="text" class="form-control" name="firstname" placeholder="Name">
								<div><small class="js-error js-error-firstname text-danger"></small></div>
							</td>
						</tr>
						<tr><th><i class="bi bi-phone"></i> Contact</th>
							<td>
								<input value="<?=$row['contact']?>" type="text" class="form-control" name="contact" placeholder="Contact">
						...
						<tr><th><i class="bi bi-person"></i> Age</th>
							<td>
								<input value="<?=$row['age']?>" type="text" class="form-control" name="age" placeholder="age">
								<div><small class="js-error js-error-age text-danger"></small></div>
							</td>
						</tr>
						<tr><th><i class="bi bi-calendar"></i> Date of Birth</th>
						<td>
							<input value="<?= $row['dob'] ?>" type="text" class="form-control" name="dob" placeholder="YYYY-MM-DD">
